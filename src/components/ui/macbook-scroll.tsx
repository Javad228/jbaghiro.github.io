...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 0.5, 1], [0, 750, 750]);
  ...
  return (
      <div
          ref={ref}
          className="min-h-[180vh] flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-50 "
      >
        <motion.h2
            style={{
        ...
        <div className="relative">
          {/* Left Label */}
          <div className="absolute left-[-60%] top-1/2 transform -translate-y-1/2 text-white text-lg z-50"
               style={{width: '250px'}}>
          <span className="writing-mode-vertical-rl transform rotate-180">
            <b>Backend Tools Used:</b> <br/>
            Python, Django, MySQL, Linux, Slurm, Git
          </span>
          </div>
          {/* Lid */}
          <Lid
          ...
          />
          {/* Right Label */}
          <div className="absolute right-[-60%] top-1/2 transform -translate-y-1/2 text-white text-lg z-50" style={{ width: '250px' }}>
          <span className="writing-mode-vertical-rl">
            <b>Frontend Tools Used:</b> <br/>
            Node.js, React, HTML/CSS, JavaScript, TypeScript
          </span>
          </div>
        </div>
        <div className="h-[22rem] w-[32rem] bg-gray-200 dark:bg-[#272729] rounded-2xl overflow-visible relative -z-10">
          {/* Above keyboard bar */}
          ...
          <Trackpad />
          <div className="h-2 w-56 mx-auto inset-x-0 absolute bottom-0 bg-gradient-to-t from-[#272729] to-[#050505] rounded-tr-3xl rounded-tl-3xl" />
          {showGradient && (
              <div className="h-40 w-full absolute bottom-0 inset-x-0 bg-gradient-to-t dark:from-black from-white via-white dark:via-black to-transparent z-50"></div>
          )}
          {badge && <div className="absolute bottom-4 left-4">{badge}</div>}
          {endLabel && (
              <div className="absolute bottom-[-200px] left-1/2 transform -translate-x-1/2 text-white text-md z-50 p-2 rounded min-w-[50rem] text-center">
                {endLabel}
              </div>
          )}
        </div>
